...
public class RegisterActivity extends Activity{
	...
	private void attemptRegister()
	{
		...
		register_password_confirm_str = register_password_confirm.getText().toString();
	...
	public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			...
			try {
		        ...
		        else if(radioSex.getCheckedRadioButtonId()==radio_female.getId())
		        {
		        	register_sex="female";
		        }
		        out.print("userRegister " + register_name_str + " " + MD5_Password + " " + register_sex + " " + register_telephone_str);
		        out.flush();
