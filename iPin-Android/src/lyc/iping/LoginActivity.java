...
public class LoginActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			String autoLogin = cursor.getString(cursor.getColumnIndex("autoLogin"));
	...
	public void attemptLogin() {
		...
		if (TextUtils.isEmpty(mEmail)) {
			mEmailView.setError(getString(R.string.error_field_required_username));
			focusView = mEmailView;
			cancel = true;
		}else if(TextUtils.isEmpty(mPassword)) {	// Check for a valid password.
