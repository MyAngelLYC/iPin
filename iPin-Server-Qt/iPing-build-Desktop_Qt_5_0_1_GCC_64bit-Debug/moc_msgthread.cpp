...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_MsgThread_t, stringdata) + ofs \
...
const QMetaObject MsgThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_MsgThread.data,
      qt_meta_data_MsgThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MsgThread.stringdata))
