/****************************************************************************
** Meta object code from reading C++ file 'subthread.h'
**
...
#include "../iPing/subthread.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'subthread.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_subThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 46, 10)
    ...
    "subThread\0processPendingDatagram\0\0"
...
const QMetaObject subThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_subThread.data,
      qt_meta_data_subThread,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_subThread.stringdata))
